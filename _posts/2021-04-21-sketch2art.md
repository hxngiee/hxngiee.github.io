...
<img src="/assets/img/sketch2art-service__architecture.png" alt="Component model visualisation">
 ...
 실제 사람이 그린 Sketch 이미지는 사진의 Edge line 이미지와 다른 형태적 특성을 가지고 있음. 이를 개선하고자, 사람들이 그린 Sketch 이미지를 모델 학습에 반영하는 MLOps 파이프라인을 구축하고 있음. 데이터 기반으로 지속적인 CI/CT/CD 환경을 만들어 모델 성능을 향상시키고 서비스의 사용성을 높이고자함. 더불어, 온라인 전시 공간 구축을 통해 누구나 손쉽게 ML Art를 접할 수 있는 Gallery를 제작하고. 작품과 공간이 조화롭게 구성된 Gallery를 통해 사용자가 조금 더 몰입감이 높은 분위기에서 작품을 감상할 수 있도록 구상하고 있음
