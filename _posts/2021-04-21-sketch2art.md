...
enforce auto-encoder to be bijective
  - Image Reconstruction (Image -> latent -> Image)
  - Content/Style Reconstruction (latent -> Image -> latent)
- GAN Loss
enforce output image should look like a cat or look like a dog using the GAN framework
